...
3. Inline citations are preferred: include the URL directly after the claim, e.g., "65% of buyers prefer self-serve ([source](https://...))" or as a markdown hyperlink.
4. If data is unavailable, explicitly state so. Label reasoned inferences as [REASONED INFERENCE — NOT SOURCED DATA]. Label synthesized quotes as [SYNTHESIZED FROM RESEARCH, NOT VERBATIM].
